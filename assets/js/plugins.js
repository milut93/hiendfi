!(function () {
                ...
                (t = {
                    ...
                    for (var a in this.waypoints[n]) {
                        var h,
                            ...
                            f = 0,
                            g = null == m;
                        d.element !== d.element.window && (f = d.adapter.offset()[r.offsetProp]),
                            "function" == typeof u ? (u = u.apply(d)) : "string" == typeof u && ((u = parseFloat(u)), d.options.offset.indexOf("%") > -1 && (u = Math.ceil((r.contextDimension * u) / 100))),
                            (h = r.contextScroll - r.contextOffset),
                            (d.triggerPoint = Math.floor(f + h - u)),
                            (l = m < r.oldScroll),
                            (p = d.triggerPoint >= r.oldScroll),
                            (c = !l && !p),
                            !g && l && p ? (d.queueTrigger(r.backward), (o[d.group.id] = d.group)) : ((!g && c) || (g && r.oldScroll >= d.triggerPoint)) && (d.queueTrigger(r.forward), (o[d.group.id] = d.group));
                    }
                }
                return (
    ...
    (function (t) {
        t.fn.hoverIntent = function (e, i, o) {
            ...
            h = "object" == typeof e ? t.extend(h, e) : t.isFunction(i) ? t.extend(h, { over: e, out: i, selector: o }) : t.extend(h, { over: e, out: e, selector: i });
            var l = function (t) {
                    (s = t.pageX), (n = t.pageY);
                },
                p = function (e, i) {
            ...
            return this.on({ "mouseenter.hoverIntent": c, "mouseleave.hoverIntent": c }, h.selector);
        };
    })(jQuery),
    (function (t) {
                ...
                function z() {
                    ...
                    "" !== (t = n.callback_before_calculation(f.val()))
                        ? (0 < n.decimals && "." === t) ||
                          ...
                          Number(t).toString() !== i.toString() && (f.val(i), f.trigger("change")))
                        : "" !== n.replacementval && (f.val(n.replacementval), f.trigger("change"));
                }
                function x() {
                    if (n.booster) {
                        ...
                        f.is("input")
                            ? ("" !==
                              ...
                              (function () {
                                  var e = f.val(),
                                      i = f.parent();
                                  "" !== e && (e = n.callback_after_calculation(Number(e).toFixed(n.decimals))),
                                      ...
                                      i.hasClass("input-group")
                                          ? (function (e) {
                                                ...
                                                s.hasClass("input-group-btn") || s.hasClass("input-group-prepend")
                                                    ? ((i = '<button class="' + n.buttondown_class + ' bootstrap-touchspin-down bootstrap-touchspin-injected" type="button">' + n.buttondown_txt + "</button>"), s.append(i))
                                                    : ((i =
                                                    ...
                                                    r.hasClass("input-group-btn") || r.hasClass("input-group-append")
                                                        ? ((o = '<button class="' + n.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected" type="button">' + n.buttonup_txt + "</button>"), r.prepend(o))
                                                        : ((o =
                                          ...
                                          : (function () {
                                                ...
                                                f.hasClass("input-sm") && (i = "input-group-sm"),
                                                    ...
                                                    f.hasClass("input-sm") ? h.addClass("input-group-sm") : f.hasClass("input-lg") && h.addClass("input-group-lg");
                                            })();
                              })(),
                              (l = {
                              ...
                              f.on("touchspin.destroy", function () {
                                  ...
                                  (e = f.parent()),
                                      W(),
                                      f.off(".touchspin"),
                                      e.hasClass("bootstrap-touchspin-injected") ? (f.siblings().remove(), f.unwrap()) : (t(".bootstrap-touchspin-injected", e).remove(), e.removeClass("bootstrap-touchspin")),
                              ...
                              f.on("touchspin.updatesettings", function (e, i) {
                                  !(function (e) {
                                      (function (e) {
                                          (n = t.extend({}, n, e)),
                                              e.postfix && (0 === f.parent().find(".bootstrap-touchspin-postfix").length && a.insertAfter(f), f.parent().find(".bootstrap-touchspin-postfix .input-group-text").text(e.postfix)),
                                              e.prefix && (0 === f.parent().find(".bootstrap-touchspin-prefix").length && r.insertBefore(f), f.parent().find(".bootstrap-touchspin-prefix .input-group-text").text(e.prefix)),
                                              y();
                                      })(e),
                                          z();
                                      var i = l.input.val();
